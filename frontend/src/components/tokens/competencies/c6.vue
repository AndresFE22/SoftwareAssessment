<template>
  <v-container class="container" style="width: 60%; border: 10px solid rgb(209, 209, 209); border-radius: 10px;">
    ...
    <v-row no-gutters>
      <v-col cols="12">
        <center><v-sheet class="pa-2 ma-1" @click="change('p3')" style="background-color: #FFF2CC; border: 1px solid gray; border-radius: 10px; text-align: center; cursor: pointer; width: 50%;">
          <strong>P3</strong>
        </v-sheet></center>
      </v-col>
